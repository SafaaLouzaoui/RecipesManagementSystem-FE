...
export class PersonneService {
 ...
 setUserPos(message?:string){
  ...
  public bloque_compte(id?: number, personne1?: Personne): Observable<Personne> {
    return this.http.post<Personne>(this.url2 + id, personne1);
  }

  public activer_compte(id?: number, personne1?: Personne): Observable<Personne> {
    return this.http.post<Personne>(this.url5 + id, personne1);
  }
  public promoteUserVersModerator(id?: number, personne1?: Personne): Observable<Personne> {
  ...
  public LoginUser (personne?:Personne ):Observable<Object>{
   ...
   public Abonner(id: number,idd: number, recette:Recette): Observable<Object> {
